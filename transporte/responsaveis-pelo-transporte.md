...
{% step %}
Clique em <img src="../.gitbook/assets/image (6).png" alt="" data-size="line"> para concluir o cadastro.
{% endstep %}
{% endstepper %}
...
2. Clique no **ícone de edição** ![](<../.gitbook/assets/image (7).png>).
...
2. Clique no **ícone** ![](<../.gitbook/assets/image (8).png>), que representa a ação de exclusão.
