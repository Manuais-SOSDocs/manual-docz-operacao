...
Esta tela permite a geração de relatórios personalizados para acompanhar a execução das atividades de indexação, possibilitando a extração de dados de forma rápida, organizada e filtrada conforme as necessidades do usuário.
