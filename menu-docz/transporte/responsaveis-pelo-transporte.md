...
<summary>👤 Cadastro de colaborador interno (Usuário SOS)</summary>
...
<summary>👥 Cadastro de colaborador terceirizado</summary>
...
{% step %}
Clique em <img src="../../.gitbook/assets/image (6) (1).png" alt="" data-size="line"> para concluir o cadastro.
{% endstep %}
{% endstepper %}
...
2. Clique no **ícone de edição** ![](<../../.gitbook/assets/image (7) (1).png>).
...
2. Clique no **ícone** ![](<../../.gitbook/assets/image (8) (1).png>), que representa a ação de exclusão.
...
<summary>🔍 Buscar colaborador</summary>
